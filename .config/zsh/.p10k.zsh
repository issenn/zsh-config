# Generated by Powerlevel10k configuration wizard on 2020-03-19 at 02:53 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 5261.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean, time,
# 2 lines, solid, right frame, lightest-ornaments, compact, many icons, concise,
